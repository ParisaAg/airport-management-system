...
from .views import flight_change_status, flight_create, flight_detail, flight_list,flight_edit,flight_delete, gate_assignment_create, gate_assignment_release
